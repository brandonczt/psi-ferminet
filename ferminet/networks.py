...
def construct_input_features(
    pos: jnp.ndarray, atoms: jnp.ndarray, ndim: int = 3
...
def make_total_ansatz(
    signed_network: FermiNetLike, n: int, complex_output: bool = False
) -> FermiNetLike:
    ...
    def total_ansatz(params, pos, spins, atoms, charges, **kwargs):
        ...
        if complex_output:
            ...
            mat_in = jnp.exp(log_in + 1.0j * sign_in - logmax)
