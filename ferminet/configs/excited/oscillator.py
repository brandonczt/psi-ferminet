...
_SYSTEMS = {
    "BH": ["B 0.00000000 0.00000000 0.00000000", "H 0.00000000 0.00000000 2.31089693"],
    "HCl": [
    ...
    "BF": ["B 0.00000000 0.00000000 0.00000000", "F 0.00000000 0.00000000 2.39729626"],
    "CO": ["C 0.00000000 0.00000000 -1.24942055", "O 0.00000000 0.00000000 0.89266692"],
    "N2": ["N 0.00000000 0.00000000 1.04008632", "N 0.00000000 0.00000000 -1.04008632"],
    "C2H4": [
...
def finalise(experiment_config: ml_collections.ConfigDict) -> ml_collections.ConfigDict:
    ...
    mol.basis = {
        atom: experiment_config.system.ecp_basis if atom in pseudo_atoms else "cc-pvdz"
        for atom in atoms
    }
    mol.ecp = {
        atom: experiment_config.system.ecp for atom in atoms if atom in pseudo_atoms
    }
