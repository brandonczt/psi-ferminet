...
class ScfTest(parameterized.TestCase):
    ...
    @parameterized.parameters(
        {"molecule": [system.Atom("He", (0, 0, 0))], "nelectrons": (1, 1)},
        {"molecule": [system.Atom("N", (0, 0, 0))], "nelectrons": (5, 2)},
        {"molecule": [system.Atom("N", (0, 0, 0))], "nelectrons": (5, 3)},
        {"molecule": [system.Atom("N", (0, 0, 0))], "nelectrons": (4, 2)},
        {
        ...
        {
            "molecule": [system.Atom("N", (0, 0, 0)), system.Atom("N", (0, 0, 1.4))],
            "nelectrons": (7, 7),
        },
        {
            "molecule": [system.Atom("O", (0, 0, 0)), system.Atom("O", (0, 0, 1.4))],
            "nelectrons": (9, 7),
            "restricted": False,
        },
    )
    def test_scf_interface(
        self,
        ...
        hf = scf.Scf(molecule=molecule, nelectrons=nelectrons, restricted=restricted)
        hf.run()
